...
def main():
    ...
    state_dict = torch.load(
        "outputs/checkpoint-gstep400/pytorch_model.bin", weights_only=False
    )
    ...
    # 8. Standard inference (without MC dropout)
    ...
    # 12. Measure the average variance to quantify uncertainty
